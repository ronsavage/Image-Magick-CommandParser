...
annotate_rule							::= minus_sign 'annotate' degrees text	action => annotate_1
											| plus_sign 'annotate' Xdegrees x Ydegrees text	action => annotate_2
											| plus_sign 'annotate' Xdegrees x Ydegrees plus_or_minus tx plus_or_minus ty text	action => annotate_3
...
blur_rule								::= minus_sign 'blur' radius	action => blur_1
											| plus_sign 'blur' radius x sigma	action => blur_2
...
canny_rule								::= minus_sign 'canny' radius	action => canny_1
											| plus_sign 'canny' radius x sigma optional_lower_percent optional_upper_percent	action => canny_2
...
clip_rule								::= plus_sign 'clip' 	action => clip_1
...
clone_rule								::= plus_sign 'clone'			action => clone_1
...
delay_rule								::= minus_sign 'delay' ticks	action => delay_1
											| plus_sign 'delay' ticks x ticks_per_second optional_greater_than optional_greater_than	action => delay_2

delete_rule								::= minus_sign 'delete' indexes	action => delete_1

density_rule							::= minus_sign 'density' width	action => density_1
											| plus_sign 'density' width x height	action => density_2
...
displace_rule							::= minus_sign 'displace' horizontal_scale	action => displace_1
											| plus_sign 'displace' horizontal_scale x vertical_scale	action => displace_2
...
gaussian_blur_rule						::= minus_sign 'gaussian-blur' radius	action => gaussian_blur_1
											| plus_sign 'gaussian-blur' radius x sigma	action => gaussian_blur_2
...
hough_lines_rule						::= minus_sign 'hough-lines' width x height optional_threshold	action => hough_lines_1
...
kuwahara_rule							::= minus_sign 'kuwahara' radius	action => kuwahara_1
											| plus_sign 'kuwahara' radius x sigma	action => kuwahara_2

label_rule								::= minus_sign 'label' name	action => label_1

lat_rule								::= minus_sign 'lat' width	action => lat_1
											| plus_sign 'lat' width x height plus_or_minus offset optional_percent	action => lat_2
...
mean_shift_rule							::= minus_sign 'mean-shift' width x height optional_plus_sign_distance optional_percent	action => mean_shift_1
...
motion_blur_rule						::= minus_sign 'motion-blur' radius	action => motion_blur_1
											| plus_sign 'motion-blur' radius x sigma plus_sign angle	action => motion_blur_2
...
random_threshold_rule					::= minus_sign 'random-threshold' low x high	action => random_threshold_1
...
resample_rule							::= minus_sign 'resample' horizontal x vertical	action => resample_1
...
sampling_factor_rule					::= minus_sign 'sampling-factor' horizontal_factor x vertical_factor	action => sampling_factor_1
...
segment_rule							::= minus_sign 'segment' cluster_threshold x smoothing_threshold	action => segment_1

selective_blur_rule						::= minus_sign 'selective-blur' radius	action => selective_blur_1
											| plus_sign 'selective-blur' radius x sigma optional_threshold	action => selective_blur_2
...
sharpen_rule							::= minus_sign 'sharpen' radius	action => sharpen_1
											| plus_sign 'sharpen' radius x sigma	action => sharpen_2

shave_rule								::= minus_sign 'shave' geometry	action => shave_1

shear_rule								::= minus_sign 'shear' Xdegrees	action => shear_1

sigmoidal_contrast_rule					::= minus_sign 'sigmoidal-contrast' contrast x mid_point	action => sigmoidal_contrast_1
...
sketch_rule								::= minus_sign 'sketch' radius	action => sketch_1
											| plus_sign 'sketch' radius x sigma plus_sign angle	action => sketch_2
...
unsharp_rule							::= minus_sign 'unsharp' radius	action => unsharp_1
											| plus_sign 'unsharp' radius x sigma optional_gain optional_threshold	action => unsharp_2
...
watermark_rule							::= minus_sign 'watermark' brightness x saturation	action => watermark_1

wave_rule								::= minus_sign 'wave' amplitude	action => wave_1
											| plus_sign 'wave' amplitude x wavelength	action => wave_2
